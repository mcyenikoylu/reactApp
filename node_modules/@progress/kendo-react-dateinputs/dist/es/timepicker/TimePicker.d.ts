...
export interface TimePickerProps extends TimePickerSettings, FormComponentProps {
     ...
     * ([see example]({% slug default_value_timepicker %}#toc-setting-the-default-value)).
     */
    defaultValue?: Date;
    /**
     * Fires each time the user selects a new value.
     * ([see example]({% slug controlled_timepicker %}#toc-controlling-the-date-value)).
     */
...
export declare class TimePicker extends React.Component<TimePickerProps, TimePickerState> implements FormComponent {
    ...
    static propTypes: {
        ...
        format: (props: TimePickerProps, propName: string, componentName: string) => void;
