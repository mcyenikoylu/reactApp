...
export interface DateRangePickerSettings {
     ...
     * ([see example]({% slug reverse_daterangepicker %})).
     *
     ...
     * [MultiViewCalendar]({% slug overview_multiviewcalendar %}) inside the DateRangePicker
     * ([see example]({% slug child_settings_daterangepicker %}#toc-configuring-the-multiviewcalendar)).
     */
     ...
     * ([see example]({% slug default_value_daterangepicker %})).
     */
    defaultShow?: boolean;
    /**
     * Determines whether the DateRangePicker is disabled
     * ([see example]({% slug disabled_daterangepicker %})).
     */
    disabled?: boolean;
    /**
     * Represents the additional props that can be passed to the end-date
     * [DateInput]({% slug overview_dateinput %}) inside the DateRangePicker
     * ([see example]({% slug child_settings_daterangepicker %}#toc-configuring-dateinputs)).
     */
    endDateInputSettings?: DateRangePickerDateInputSettings;
    /**
     * Specifies the focused date of the DateRangePicker
     * ([see example]({% slug focused_daterangepicker %})).
     */
    focusedDate?: Date;
    /**
     ...
     * ([see example]({% slug dateranges_daterangepicker %})).
     */
    max?: Date;
    /**
     ...
     * [Popup]({% slug overview_popup %}) inside the DateRangePicker
     * ([see example]({% slug child_settings_daterangepicker %}#toc-configuring-the-popup)).
     */
    popupSettings?: DateRangePickerPopupSettings;
    /**
     * Specifies if the calendar will be displayed
     * ([see example]({% slug controlled_daterangepicker %}#toc-controlling-the-popup-state)).
     */
    show?: boolean;
    /**
     ...
     * ([see example]({% slug reverse_daterangepicker %}#toc-swapping-start-and-end-dates-in-ranges)).
     *
     * > The DateRangePicker will display the swap button only if the
     * [`allowReverse`](#toc-allowreverse) property is also set to `true`.
     */
    swapButton?: boolean;
    /**
