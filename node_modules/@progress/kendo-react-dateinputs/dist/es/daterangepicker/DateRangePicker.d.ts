...
export interface DateRangePickerProps extends DateRangePickerSettings {
     ...
     * ([see example]({% slug controlled_daterangepicker %}#toc-controlling-the-value)).
     */
     ...
     * > [`Date`](https://developer.mozilla.org/en/docs/Web/JavaScript/Reference/Global_Objects/Date) instances or `null`.
     */
    value?: SelectionRange;
}
/**
