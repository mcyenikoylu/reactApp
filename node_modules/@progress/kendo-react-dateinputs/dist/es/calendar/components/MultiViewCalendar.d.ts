 ...
 */
export interface MultiViewCalendarChangeEvent {
    syntheticEvent: React.SyntheticEvent<any>;
    nativeEvent: any;
    value: Date | Date[] | SelectionRange | null;
    target: MultiViewCalendar;
}
/**
 * Represents the props of the [KendoReact MultiViewCalendar component]({% slug overview_multiviewcalendar %}).
 */
export interface MultiViewCalendarProps extends MultiViewCalendarSettings {
    /**
     ...
     * The new value is generated based on the current `mode` of the MultiViewCalendar.
     */
    onChange?: (event: MultiViewCalendarChangeEvent) => void;
    /**
     * Sets the value of the MultiViewCalendar.
     * Based on the value type, the MultiViewcalendar renders a single, multiple, or range selection.
     */
    value?: Date | Date[] | SelectionRange | null;
}
/**
