...
var ViewList = /** @class */ (function (_super) {
    ...
    ViewList.prototype.render = function () {
        ...
        var viewListBody = [
            (React.createElement(Header, { key: "calendar-view-list-header", currentDate: activeDate, min: this.props.min, max: this.props.max, activeView: this.props.activeView, onTodayClick: this.handleTodayClick, bus: this.props.bus, service: this.props.service })),
