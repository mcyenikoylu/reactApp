...
var Navigation = /** @class */ (function (_super) {
    ...
    function Navigation(props) {
        ...
        _this.handleDateChange = function (candidate, event) {
            var onChange = _this.props.onChange;
            if (onChange) {
                var value = kendo_date_math_1.cloneDate(candidate);
                var args = {
    ...
    Navigation.prototype.render = function () {
        ...
        var navigationBody = (React.createElement(Virtualization_1.Virtualization, { skip: skip, take: this.take, total: total, itemHeight: this.itemHeight, topOffset: this.topOffset, bottomOffset: this.bottomOffset, maxScrollDifference: this.maxViewHeight, onScrollAction: this.handleScrollAction, onMount: this.handleVirtualizationMount },
            React.createElement("ul", { ref: function (el) { _this.list = el; }, className: "k-reset" }, dates.map(function (date, idx) { return (React.createElement("li", { key: idx, onClick: function (event) { _this.handleDateChange(date, event); }, ref: function (el) { if (!_this.listItem) {
                    _this.listItem = el;
                } } },
                React.createElement("span", { className: kendo_react_common_1.classNames({
                        'k-calendar-navigation-market': _this.props.service.isRangeStart(date)
                    }) }, _this.props.service.navigationTitle(date)))); }))));
