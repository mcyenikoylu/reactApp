...
var ViewList = /** @class */ (function (_super) {
        ...
        _this.buildDates = function (cols, dates) {
            ...
            return (React.createElement("table", { ref: function (table) { return _this.table = table; } },
                ...
                dates.map(function (date) { return (React.createElement(View_1.View, { ref: function (el) { if (!_this.calendarView) {
                    ...
                    } }, key: date.getTime(), activeView: _this.props.activeView, viewDate: date, min: _this.props.min, max: _this.props.max, cellUID: cellUID, focusedDate: _this.props.focusedDate, selectedDate: _this.props.value, showWeekNumbers: _this.weekNumber, onChange: _this.handleDateChange, bus: _this.props.bus, service: _this.props.service })); })));
        };
    ...
    ViewList.prototype.render = function () {
        ...
        var viewListBody = [
            (React.createElement(Header_1.Header, { key: "calendar-view-list-header", currentDate: activeDate, min: this.props.min, max: this.props.max, activeView: this.props.activeView, onTodayClick: this.handleTodayClick, bus: this.props.bus, service: this.props.service })),
