...
export interface DatePickerProps extends DatePickerSettings, FormComponentProps {
    /**
     * Sets the default value of the DatePicker
     * ([see example]({% slug default_value_datepicker %})).
     */
    defaultValue?: Date;
    /**
     * Fires each time the user selects a new value
     * ([see example]({% slug controlled_datepicker %}#toc-controlling-the-date-value)).
     */
