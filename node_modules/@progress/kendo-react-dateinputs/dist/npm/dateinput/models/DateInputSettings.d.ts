...
export interface DateInputSettings {
     ...
     * ([more information and example]({% slug placeholders_dateinput %}).
     */
     ...
     * ([see example]({% slug incrementalsteps_dateinput %}).
     *
    ...
    min?: Date;
    /**
     * Specifies the greatest date that is valid
     * ([see example]({% slug dateranges_dateinput %}).
     */
    max?: Date;
    /**
     * Determines whether the DateInput is disabled
     * ([see example]({% slug disabled_dateinput %})).
     */
    disabled?: boolean;
    /**
     * Specifies whether the **Up** and **Down** spin buttons will be rendered
     * ([see example]({% slug spinbuttons_dateinput %})).
     */
    spinners?: boolean;
    /**
