...
export interface TimePickerSettings {
     ...
     * ([see example]({% slug default_value_timepicker %}#toc-setting-the-default-popup-state)).
     */
    defaultShow?: boolean;
    /**
     ...
     * ([see example]({% slug placeholders_timepicker %})).
     */
     ...
     * - `appendTo`: &mdash; Defines the container to which the Popup will be appended.
     ...
     * ([see example]({% slug controlled_timepicker %}#toc-controlling-the-popup-state)).
     */
    show?: boolean;
    /**
     * Configures the incremental steps of the TimePicker
     * ([see example]({% slug incrementalsteps_timepicker %})).
     *
