...
var TimePicker = /** @class */ (function (_super) {
    ...
    TimePicker.prototype.render = function () {
        ...
        return (React.createElement("span", { ref: function (span) { _this._element = span; }, className: rootClassName, onKeyDown: this.handleKeyDown, style: { width: width }, onFocus: this.handleFocus, onBlur: this.handleBlur },
            ...
            React.createElement(kendo_react_popup_1.Popup, __assign({ show: this.show, animate: this._wrapper !== null, anchor: this._wrapper || undefined, className: popupClassNames, id: this._popupId, anchorAlign: {
                    horizontal: 'left',
                    vertical: 'bottom'
                }, popupAlign: {
                    horizontal: 'left',
                ...
                React.createElement(TimeSelector_1.TimeSelector, { ref: function (timeSelector) { _this._timeSelector = timeSelector; }, cancelButton: cancelButton, disabled: disabled, nowButton: nowButton, format: format, min: this.min, max: this.max, steps: steps, smoothScroll: smoothScroll, value: this.value, onChange: this.handleValueChange, onReject: this.handleValueReject }))));
    };
