...
export interface NumericTextBoxState {
    ...
    value: number | null;
    /**
     * Represents the text that the user is currently typing.
     * If valid, it will be applied the next time when the NumericTextBox is rendered.
     */
    looselyFormattedText: string | null;
    /**
     * Represents the beginning of the selected portion of the input content
     * that will be applied the next time when the NumericTextBox is rendered.
     */
    selectionStart: number;
    /**
     * Represents the ending of the selected portion of the input content
     * that will be applied the next time when the NumericTextBox is rendered.
     */
    selectionEnd: number;
    /**
