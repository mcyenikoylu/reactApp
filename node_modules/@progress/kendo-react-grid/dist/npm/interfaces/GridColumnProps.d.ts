...
export interface GridColumnProps {
     ...
     * form where `format` is a standard number format, a custom number format, a standard date
     * format, or a custom date format. For more information on the supported date and number formats,
     ...
     * ([see example]({% slug column_menu_grid %}#toc-basic-usage)).
     */
