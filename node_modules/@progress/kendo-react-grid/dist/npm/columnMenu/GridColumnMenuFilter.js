...
var GridColumnMenuFilter = /** @class */ (function (_super) {
    ...
    /**
     * Can be used to check if filtering is applied to a specific field
     * ([see example]({% slug column_menu_grid %}#toc-styling-the-column-menu-icon)).
     * Useful for creating active filter indicators.
     */
