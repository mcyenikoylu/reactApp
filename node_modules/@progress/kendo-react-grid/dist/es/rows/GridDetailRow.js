...
/**
 * Represents the detail row class of the KendoReact Grid. Used to define custom
 * details for each row. Can be applied for building the hierarchy. If `expandField` is
 * set, the details for each row will be visible or hidden depending on the
 * current data item and its `expandField` value.
 *
 * @example
 * ```jsx
