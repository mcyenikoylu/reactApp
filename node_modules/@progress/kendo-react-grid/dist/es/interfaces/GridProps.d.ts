...
export interface GridProps {
     ...
     * ([more information and examples in the documentation on filtering]({% slug filtering_grid %})).
     */
    filterable?: boolean;
    /**
     ...
     * Can be overridden on column level.
     */
    columnMenu?: null | ComponentType<GridColumnMenuProps>;
    /**
     * The descriptors by which the data will be grouped
     * ([more information and examples in the documentation on grouping]({% slug groupingbasics_grid %})).
     */
     ...
     * ([more information and example]({% slug selection_grid %})).
     */
     ...
     * ([more information and examples in the documentation on editing]({% slug editing_inline_grid %})).
     */
     ...
     * item ([more information and examples in the documentation on editing]({% slug editing_inline_grid %})).
     */
    editField?: string;
    /**
     ...
     * of the currently expanded items ([see example]({% slug hierarchy_grid %}).
     ...
     * ([more information]({% slug localoperations_grid %}) and [example]({% slug odataserveroperations_grid %})).
     */
