...
var GridGroupCell = /** @class */ (function (_super) {
    ...
    GridGroupCell.prototype.render = function () {
        ...
        if (columnIndex === undefined || level === undefined || columnIndex < level ||
            ...
            defaultRendering = (React.createElement("td", { key: 'g' + columnIndex, className: "k-group-cell" }));
        }
        else if (columnIndex <= level) {
            defaultRendering = (React.createElement("td", { key: 'g-colspan', colSpan: columnsCount - columnIndex },
