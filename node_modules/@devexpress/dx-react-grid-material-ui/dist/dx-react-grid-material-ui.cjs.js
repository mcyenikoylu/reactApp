...
var Item = styles.withStyles(styles$2, {
  name: 'Item'
})(ItemBase);
...
var Container$1 = styles.withStyles(styles$3, {
  name: 'DragDrop'
})(ContainerBase);
...
var Column = styles.withStyles(styles$3, {
  name: 'DragDrop'
})(ColumnBase);
...
var PageSizeSelector = styles.withStyles(styles$4, {
...
var Pagination = styles.withStyles(styles$5, {
  name: 'Pagination'
})(PaginationBase);
...
var Pager = styles.withStyles(styles$6, {
  name: 'Pager'
})(PagerBase);
...
var GroupPanelContainer = styles.withStyles(styles$7, {
...
var GroupPanelItem = styles.withStyles(styles$8, {
  name: 'GroupPanelItem'
})(GroupPanelItemBase);
...
var GroupPanelEmptyMessage = styles.withStyles(styles$9, {
...
var TableDetailToggleCell = styles.withStyles(styles$a, {
...
var TableDetailCell = styles.withStyles(styles$b, {
...
var Cell = styles.withStyles(styles$c, {
  name: 'TableGroupCell'
})(CellBase);

var styles$d = function styles$$1() {
  return {
    columnTitle: {
      verticalAlign: 'middle'
    }
...
var ContentBase = function ContentBase(_ref) {
  ...
  }, restProps), React.createElement("strong", null, column.title || column.name, ":", ' '), children || row.value);
};
...
var Content = styles.withStyles(styles$d)(ContentBase);
...
var Icon = styles.withStyles(styles$e)(IconBase);
...
var styles$f = function styles$$1(theme) {
  return {
    cell: {
      overflow: 'visible',
      paddingRight: 0,
...
var TableSelectAllCell = styles.withStyles(styles$f, {
  name: 'TableSelectAllCell'
})(TableSelectAllCellBase);

var styles$g = function styles$$1(theme) {
  return {
    cell: {
      overflow: 'visible',
      paddingRight: 0,
...
var TableSelectCell = styles.withStyles(styles$g, {
...
var styles$h = function styles$$1(theme) {
  return {
    table: {
      tableLayout: 'fixed',
...
var TableBase = function TableBase(_ref) {
  ...
  var children = _ref.children,
      ...
      className = _ref.className,
      use = _ref.use,
      restProps = _objectWithoutProperties(_ref, ["children", "classes", "className", "use"]);
...
var Table = styles.withStyles(styles$h, {
  name: 'Table'
})(TableBase);
...
var styles$i = function styles$$1(theme) {
  return {
    cell: {
      paddingRight: theme.spacing.unit,
      paddingLeft: theme.spacing.unit,
...
var TableCell$1 = styles.withStyles(styles$i, {
  name: 'TableCell'
})(TableCellBase);

var styles$j = function styles$$1(theme) {
  return {
    cell: {
      padding: 0
    },
...
var TableStubCell = styles.withStyles(styles$j, {
  name: 'TableStubCell'
})(TableStubCellBase);

var styles$k = function styles$$1(theme) {
  return {
    cell: {
    ...
    text: {
      ...
      width: '100%',
      textAlign: 'center',
      marginTop: "-".concat(theme.spacing.unit, "px")
    }
  };
};
...
var TableNoDataCell = styles.withStyles(styles$k, {
...
var TableContainer = styles.withStyles(styles$l, {
  name: 'TableContainer'
})(TableContainerBase);
...
var styles$m = function styles$$1(_ref) {
...
var TableFilterCell = styles.withStyles(styles$m, {
...
var Editor = styles.withStyles(styles$n, {
  name: 'Editor'
})(EditorBase);

var styles$o = function styles$$1(_ref) {
  var spacing = _ref.spacing;
  return {
    icon: {
...
var FilterSelector = styles.withStyles(styles$o, {
  name: 'FilterSelector'
})(FilterSelectorBase);
...
var ResizingControl = styles.withStyles(styles$p, {
  name: 'ResizingControl'
})(ResizingControlBase);

var styles$q = function styles$$1(theme) {
  return {
    plainTitle: {
      overflow: 'hidden',
      textOverflow: 'ellipsis',
...
function (_React$PureComponent) {
  ...
  _createClass(TableHeaderCellBase, [{
    ...
    value: function render() {
      ...
      var cellLayout = React.createElement(TableCell, _extends({
        style: style,
...
var TableHeaderCell = styles.withStyles(styles$q, {
...
var styles$r = function styles$$1() {
  return {
    root: {
      width: '100%',
      userSelect: 'none',
...
var SortLabel = styles.withStyles(styles$r, {
  name: 'SortLabel'
})(SortLabelBase);
...
var GroupButton = styles.withStyles(styles$s, {
  name: 'GroupButton'
})(GroupButtonBase);
...
var Title = styles.withStyles(styles$t, {
  name: 'Title'
})(TitelBase);
...
var Content$1 = styles.withStyles(styles$u, {
  name: 'Content'
})(ContentBase$1);
...
var Cell$1 = styles.withStyles(styles$v, {
  name: 'Cell'
})(CellBase$1);
...
var BandedHeaderCell = styles.withStyles(styles$w, {
...
var InvisibleCell = styles.withStyles(styles$x, {
  name: 'InvisibleCell'
})(InvisibleCellBase);
...
var Row = styles.withStyles(styles$y, {
  name: 'Row'
})(RowBase);
...
var EditCell = styles.withStyles(styles$z, {
  name: 'EditCell'
})(EditCellBase);
...
var withEditColumnStyles = styles.withStyles(styles$A, {
  name: 'EditColumn'
});
...
var EmptyMessageBase = function EmptyMessageBase(_ref) {
  ...
  return React.createElement(Toolbar, restProps, React.createElement("big", {
...
var EmptyMessage = styles.withStyles(styles$B, {
  name: 'EmptyMessage'
})(EmptyMessageBase);
...
var styles$C = function styles$$1() {
  return {
    row: {
      visibility: 'hidden'
    }
...
var TableInvisibleRow = styles.withStyles(styles$C, {
...
var Toolbar$1 = styles.withStyles(styles$D, {
  name: 'Toolbar'
})(ToolbarBase);
...
var Toolbar$2 = dxReactCore.withComponents({
  Root: Toolbar$1,
...
var TableTreeExpandButton = styles.withStyles(styles$E)(TableTreeExpandButtonBase);
...
var TableTreeCheckbox = styles.withStyles(styles$F)(TableTreeCheckboxBase);
...
var TableTreeIndent = styles.withStyles(styles$G)(TableTreeIndentBase);

var styles$H = function styles$$1() {
  return {
    content: {
      width: '100%',
      overflow: 'hidden',
...
var TableTreeContent = styles.withStyles(styles$H)(TableTreeContentBase);
...
var TableTreeCell = styles.withStyles(styles$I)(TableTreeCellBase);
...
var SearchPanelInput = styles.withStyles(styles$J)(SearchPanelInputBase);
...
var FixedCell = styles.withStyles(styles$K, {
  name: 'TableFixedCell'
})(FixedCellBase);

var styles$L = function styles$$1() {
  return {
    cell: {
      border: 0
    }
...
var TableBorderlessStubCell = styles.withStyles(styles$L, {
...
var styles$M = function styles$$1(theme) {
  return {
    item: {
...
var TableSummaryItem = styles.withStyles(styles$M)(TableSummaryItemBase);

var TableSummaryRow = dxReactCore.withComponents({
  TotalRow: TableRow,
  GroupRow: TableRow,
  TreeRow: TableRow,
  TotalCell: TableCell$1,
  GroupCell: TableCell$1,
  TreeCell: TableCell$1,
