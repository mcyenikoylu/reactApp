...
import { Grid, ColumnChooser, DragDropProvider, PagingPanel, GroupingPanel, TableRowDetail, TableGroupRow, TableSelection, TableLayout, StaticTableLayout, Table, VirtualTableLayout, makeVirtualTable, TableFilterRow, TableHeaderRow, TableBandHeader, TableEditRow, TableEditColumn, TableColumnVisibility, TableColumnReordering, TableColumnResizing, Toolbar as Toolbar$1, TableTreeColumn, SearchPanel, TableFixedColumns, TableSummaryRow } from '@devexpress/dx-react-grid';
import { createElement, PureComponent, createRef, Fragment } from 'react';
import { node, shape, string, oneOfType, func, number, object, bool, oneOf, any, arrayOf } from 'prop-types';
...
var DragDropProvider$1 = withComponents({
...
var ContentBase = function ContentBase(_ref) {
  ...
  }, restProps), createElement("strong", null, column.title || column.name, ":", ' '), children || row.value);
};
...
var TableCell$1 = withStyles(styles$h, {
  name: 'TableCell'
})(TableCellBase);
...
Table$2.COLUMN_TYPE = Table.COLUMN_TYPE;
Table$2.ROW_TYPE = Table.ROW_TYPE;
Table$2.NODATA_ROW_TYPE = Table.NODATA_ROW_TYPE;
...
var FixedHeader = function FixedHeader(props) {
  return createElement(Table$1, _extends({
    use: "head"
  }, props));
};
...
var VirtualTable = makeVirtualTable(Table$2, {
...
VirtualTable.COLUMN_TYPE = Table$2.COLUMN_TYPE;
VirtualTable.ROW_TYPE = Table$2.ROW_TYPE;
VirtualTable.NODATA_ROW_TYPE = Table$2.NODATA_ROW_TYPE;
...
function (_React$PureComponent) {
  ...
  _createClass(TableHeaderCellBase, [{
    ...
    value: function render() {
      ...
      var cellLayout = createElement(TableCell, _extends({
        style: style,
...
var EmptyMessageBase = function EmptyMessageBase(_ref) {
  ...
  return createElement(Toolbar, restProps, createElement("big", {
...
/*#__PURE__*/
function (_React$PureComponent) {
  _inherits(TableColumnResizing$$1, _React$PureComponent);

  function TableColumnResizing$$1() {
    _classCallCheck(this, TableColumnResizing$$1);

    return _possibleConstructorReturn(this, _getPrototypeOf(TableColumnResizing$$1).apply(this, arguments));
  }

  _createClass(TableColumnResizing$$1, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
...
var Toolbar$2 = withStyles(styles$C, {
  name: 'Toolbar'
})(ToolbarBase);
